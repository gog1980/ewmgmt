...
use \DateTime;
use \Exception;
//use \LAMgmt\Validation\AlumneValidator;

/**
 * Model class representing one Alumnes item.
 */
final class Alumne {
    ...
    /**
     * Create new {@link Alumne} with default properties set.
     */
    ...
    public function getDataIngres() {
        return $this->data_ingres;
    }

    public function setDataIngres(DateTime $value) {
        $this->data_ingres = $value;
    }    
